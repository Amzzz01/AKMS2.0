...
<div class="container-fluid">
    ...
    <div class="content-card animate-in">
        <div class="card-header">
            ...
            <a href="{{ route('admin.list') }}" class="view-all-btn">
        ...
        <div class="content-card">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 1rem;">
                <div style="text-align: center; padding: 1rem; background: rgba(76, 175, 80, 0.1); border-radius: 10px;">
                    ...
                    <div style="font-weight: 600; color: #4CAF50;">Database</div>
                    <div style="font-size: 0.8rem; color: #64748b;">Online</div>
                </div>
                <div style="text-align: center; padding: 1rem; background: rgba(33, 150, 243, 0.1); border-radius: 10px;">
                    <i class="fas fa-cloud" style="font-size: 2rem; color: #2196F3; margin-bottom: 0.5rem;"></i>
                    <div style="font-weight: 600; color: #2196F3;">Server</div>
                    <div style="font-size: 0.8rem; color: #64748b;">Healthy</div>
                </div>
                <div style="text-align: center; padding: 1rem; background: rgba(255, 152, 0, 0.1); border-radius: 10px;">
                    <i class="fas fa-backup" style="font-size: 2rem; color: #FF9800; margin-bottom: 0.5rem;"></i>
                    <div style="font-weight: 600; color: #FF9800;">Backup</div>
                    <div style="font-size: 0.8rem; color: #64748b;">{{ now()->format('d M') }}</div>
                </div>
            </div>
        </div>
